...
while running:
    ...
    for i in range(hit):
        if hit != prevHit:
            ballvelocityy *= 1.04
            ballvelocityx *= 1.04
    print(ballvelocityx,ballvelocityy)

    if ((ballx >= 0 and ballx <= base_x + 60) and (bally >= base_y and bally <= base_y+125)) or ((ballx >= base2_x-20 and ballx <= 1230) and (bally >= base2_y and bally <= base2_y+125)):
 ...
 ############Controls       
    ...
    if not twoPlayers:
        #  AI logic
        if bally < base2_y + 62 and base2_y > 10:
            base2_y -= 1
        if bally > base2_y + 62 and base2_y < 550:
            base2_y += 1
